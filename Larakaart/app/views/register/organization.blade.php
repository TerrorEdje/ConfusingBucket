...
<form action="{{ URL::route('Register-organization-post') }}" method="post" class="form-horizontal">
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-8">
	    	...
	    	<button type="submit" class="btn btn-success">Register Organization & login</button>
	    </div>
		{{ Form::token() }}
	</div>
</form>