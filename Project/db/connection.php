<?php	 
	function openDB()
	{
		$db_hostname = "212.83.232.237:3306"; // De locatie waar de MySQL-service draait
		...
		$db_name = "Worldmap"; // De name van de database zelf, deze moet via de DBMS worden aangemaakt
